...
export default function GeneralContractorsSoftware() {
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="General Contractor Software 2026 | All Trades | $89/mo Total"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you manage remodeling, roofing, concrete, flooring, or run multiple specialty trades, Crew Ops Pro adapts to your business. One platform for every field service trade.
            </p>
          </div>
