        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you specialize in chimney sweeping, fireplace repair, dryer vent cleaning, or run a multi-trade operation, Crew Ops Pro adapts to your business. One platform for every field service trade.
            </p>
          </div>
