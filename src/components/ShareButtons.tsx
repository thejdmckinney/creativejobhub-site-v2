...
export default function ShareButtons({ url, title, description }: ShareButtonsProps) {
  ...
  const shareUrl = `https://www.crewopspro.com${url}`;
  ...
  return (
    <div className="border-t border-gray-200 pt-6 mt-6">
      ...
      {/* Social Share Links (shown when native share isn't available or as fallback) */}
      {showShareMenu && (
      ...
      {/* Always show social links on desktop */}
      <div className="hidden md:flex flex-wrap gap-3 mt-4">
        <a
          href={shareLinks.twitter}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-3 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors text-sm"
