    ...
    <div className="bg-white">
      ...
      <div className="border-b border-gray-200 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex space-x-4 lg:space-x-8 overflow-x-auto scrollbar-hide" aria-label="Industry tabs">
            {industries.map((industry) => (
              <button
                key={industry.id}
                onClick={() => setActiveTab(industry.id)}
                className={`py-4 px-3 border-b-2 font-semibold text-base lg:text-lg transition-colors whitespace-nowrap flex-shrink-0 ${
