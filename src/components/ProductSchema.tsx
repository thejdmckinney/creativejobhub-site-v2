...
export default function ProductSchema() {
  const schema = {
    ...
    "image": [
      "https://www.crewopspro.com/src/assets/crewopspro-home-page.webp",
      "https://www.crewopspro.com/src/assets/dashboard-view.webp",
      "https://www.crewopspro.com/src/assets/scheduling-page.webp"
    ],
    "brand": {
      "@type": "Brand",
      "name": "Crew Ops Pro"
